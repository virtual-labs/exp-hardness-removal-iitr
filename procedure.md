...
1. **Ion Exchange Column:**  
   Pass the water sample through the ion exchange column containing cation exchange resin, discard the first few milliliters of water, then collect the water sample
...
2. **Standardization of EDTA solution:**  
   ...
   (iii) Fill the burette with EDTA solution after rinsing. Note the initial burette reading. Titrate the solution in the conical flask until the wine-red color changes to blue and record the final burette reading.
...
4. Add basic buffer (NH4Cl + NH4OH) to maintain the pH =10 during titration. Add ammonia buffer just before starting the titration if you add long before the titration pH of the solution may vary due to evolution of NH3(g) from the solution.
